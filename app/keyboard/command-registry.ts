...
const BASE_COMMAND_REGISTRY: CommandBaseDefinition[] = [
  ...
  },
  {
    ...
    title: "درج بلوک کد",
    group: "edit",
    bindings: [{ code: "KeyC", alt: true, shift: true }],
    allowInEditable: ["editor"],
    showInHelp: true,
    contextLabel: "فقط در ویرایشگر؛ مستقل از زبان صفحه‌کلید",
  },
  {
    id: "edit.callout",
    title: "فراخوان",
...
const COMMAND_METADATA = {
  ...
  "edit.codeBlock": { description: "انتخاب را به بلوک کد چندخطی و قابل ویرایش تبدیل می‌کند.", keywords: ["code block", "fence", "بلوک کد", "کد چندخطی", "قطعه کد"], icon: "code" },
