...
const UNIQUE_FEATURES = [
  ...
  {
    icon: Library,
    title: "کتابخانه روی دستگاه شما",
    description:
      "فایل‌های اصلی در پوشهٔ انتخابی شما می‌مانند. اتصال هوش مصنوعی و پشتیبان‌گیری ابری، مسیرهای جداگانه و اختیاری‌اند.",
  },
  {
    icon: FileArchive,
...
const CURRENT_CHANGES = [
  "اتصال یک‌دکمه‌ای به ChatGPT؛ دریافت خودکار Codex بدون نیاز به نصب جداگانهٔ Node یا npm و تشخیص اتصال بدون اجرای دوبارهٔ راوی",
  "نمایش خودکار راهنمای شروع فقط در نصب نخست؛ حفظ وضعیت کاربران هنگام ارتقا",
  "پایداری جدول هنگام تغییر تم و جابه‌جایی فوکوس؛ حفظ سلول هنگام ثبت ویرایش و ورود صریح به Markdown خام",
  "نسخهٔ مستقل راوی لایت برای موبایل و تبلت در وب؛ هدایت خودکار به مسیر /light/",
  "دسترسی به همین پنجره از نام راوی در هدر و منوی «…»، با پشتیبانی صفحه‌کلید و بازگشت تمرکز",
  "انتخاب هم‌وزن Word و PDF؛ پیش‌نمایش واقعی PDF در دسکتاپ، تغییر جهت و کنترل‌های خوانا در هر دو تم",
  "فرمول‌های قابل‌ویرایش Word در ساختارهای پشتیبانی‌شده و هشدار همراه با دسترسی به محل فرمول برای سایر موارد",
  "زمینهٔ جمع‌شونده، راهنمای کلید /، آیکن‌های گویاتر و بازبینی و بازگردانی تغییرات راوی هوشمند",
  "نمودار XY با چند سری و شمار نقاط؛ تفکیک رنگ صفحهٔ نوشتن از پس‌زمینه در دو تم",
  "تقویت نگه‌داری تب‌ها و تغییرات ذخیره‌نشده و جست‌وجوی سندهای بلند",
] as const;
...
const RELEASES = [
  ...
  },
  {
    version: "2.4.5",
    dateTime: "2026-09-06",
    dateLabel: "۱۵ شهریور ۱۴۰۵",
    changes: [
      "اصلاح پنجرهٔ نظر، ذخیرهٔ مقاوم‌تر فایل و جداسازی اجرای Mermaid از پنجرهٔ اصلی",
      "اصلاح جست‌وجو و پیمایش سندهای بلند، حفظ جای مطالعه و تمرکز استودیوی فرمول",
      "افزودن Persian IPA F5-TTS با مبدل فارسی‌به‌IPA و Vocos کاملاً آفلاین",
      "مهاجرت خودکار همهٔ داده‌ها به مسیر انگلیسی Raavi در ویندوز",
      "رفع نصب گویا در مسیر فارسی، قفل کاذب دریافت و متن خام خطاهای Electron",
    ],
  },
  {
    version: "2.4.4",
    ...
    changes: [
      "افزودن Gooya V1 با مجوز اختصاصی آوا صبای ملل و آوانویسی فارسی Negara",
      "بستهٔ آفلاین کامل مدل، کُدک و runtime با کنترل SHA-256",
      "تقسیم محافظه‌کارانهٔ متن، بازتولید خروجی ناقص و بافر پنج‌قطعه‌ای",
    ],
  },
  {
    version: "2.4.3",
    dateTime: "2026-09-01",
    dateLabel: "۱۰ شهریور ۱۴۰۵",
    changes: [
      "پیش‌پردازش اجباری فارسی و تقسیم امن جمله‌های بلند برای آوا",
      "بافر ۳ تا ۵ قطعه‌ای، کش ماندگار و بازتولید تطبیقی صدای ناقص",
      "کارگردان هوشمند اختیاری با اتصال ChatGPT و بازگشت خودکار به خوانش محلی",
    ],
  },
  {
    version: "2.4.2",
    ...
    dateLabel: "۱۰ شهریور ۱۴۰۵",
    changes: [
      "افزودن موتور محلی Meta MMS فارسی با برچسب روشن استفادهٔ پژوهشی و غیرتجاری",
      "تفکیک حجم مدل، فایل‌های همراه، runtime و Python همراه با دانلود واقعی موردنیاز",
      "پیام‌های خطای فارسی و قابل‌اقدام به‌جای خروجی خام شبکه، سرور یا Python",
    ],
  },
  {
    version: "2.4.1",
    ...
    dateLabel: "۱۰ شهریور ۱۴۰۵",
    changes: [
      "بازسازی خودکار محیط Python نیمه‌کاره هنگام تکرار نصب موتور شنیدن",
      "نمایش روشن‌تر مرحلهٔ نصب وابستگی‌های محلی و زمان‌بر بودن آن",
      "میزبانی Python، Piper، Torch و Kokoro روی هاست دانلود راوی با کنترل SHA-256",
    ],
  },
  {
    version: "2.4.0",
    ...
    dateLabel: "۱۰ شهریور ۱۴۰۵",
    changes: [
      "شنیدن محلی متن فارسی در حالت مطالعه با موتورهای مانا و آوا",
      "تولبار معلق پخش، سرعت و جابه‌جایی پاراگراف با هایلایت هم‌زمان جملهٔ جاری",
      "مدیریت دانلود، نمونه، انتخاب و حذف مدل‌ها همراه با کنترل نسخه و SHA-256",
    ],
  },
  {
    version: "2.3.0",
    dateTime: "2026-08-28",
    dateLabel: "۷ شهریور ۱۴۰۵",
    changes: [
      "انتخاب متن و پیمایش خط‌به‌خط پایدار در نماهای نوشتن، کد و مطالعه، بدون پرش جدول یا اسکرول",
      "پنهان‌ماندن کد خام Mermaid و فرمول در نمای نوشتن و حفظ نمای باکس‌دار قابل‌ویرایش",
      "بهبود First Run و تنظیمات و پاک‌سازی کامل هشدارهای lint و گیت ساخت",
    ],
  },
  {
    version: "2.2.1",
    ...
    changes: [
      ...
      "ویرایش مستقیم کد و فراخوان در متن، با حفظ نمای باکس‌دار برای عکس، جدول، فرمول، Mermaid و صوت",
    ],
  },
  {
    version: "2.1.13",
    ...
    >
      ...
      <div className="about-modal-scroll">
        <section className="about-intro" id="about-modal-description">
          ...
          <p>
            فایل‌های اصلی و یادداشت‌ها روی دستگاه نگه‌داری می‌شوند. هنگام استفاده
            از هوش مصنوعی، زمینهٔ درخواست به سرویس متصل ارسال می‌شود؛ پشتیبان‌گیری
            ابری نیز تنها با فعال‌کردن آن انجام می‌شود.
          </p>
        </section>
      ...
      <footer className="about-modal-footer">
        <span>
          ...
          ذخیرهٔ محلی سند؛ اتصال‌های ابری اختیاری
        </span>
