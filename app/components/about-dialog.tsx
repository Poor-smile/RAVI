...
const UNIQUE_FEATURES = [
  ...
  },
  {
    ...
    description:
      "تصویر محلی داخل فایل .ravi همراه سند می‌ماند؛ تصویر اینترنتی فقط با URL ارجاع داده می‌شود تا فایل سبک بماند.",
  },
  {
    icon: PanelLeftOpen,
...
const RELEASES = [
  ...
  },
  {
    ...
    dateLabel: "۹ مرداد ۱۴۰۵",
    changes: [
      "تبدیل مسیر URL تصویر به ارجاع مستقیم، بدون دانلود یا افزودن دادهٔ تصویر به فایل .ravi",
