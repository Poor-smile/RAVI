...
در حالت مطالعه، برگ خواندن عنصر اصلی است و فهرست فصل‌های استخراج‌شده از تیترهای Markdown در سایدبار سمت راست قرار می‌گیرد. سایدبار در حالت باز ۲۸۰ پیکسل و در حالت جمع‌شده ۴۸ پیکسل است؛ روی موبایل به‌صورت پنل ثابت روی متن باز می‌شود تا عرض خواندن ثابت بماند.
