...
const SECURITY_HEADERS = {
  "Content-Security-Policy":
    "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: http: https:; media-src 'self' blob: raavi-audio:; font-src 'self' data:; connect-src 'self' blob: raavi-audio:; object-src 'none'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'",
