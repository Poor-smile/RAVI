...
- بروزرسانی First Run را دوباره باز نکند؛ نمایش خودکار فقط در اولین نصب با
  پروفایل تازه مجاز است، مستقل از وضعیت اتصال ChatGPT یا بکاپ. راهنما باید
  برای کاربر قدیمی از مسیر دستی قابل دسترسی بماند.
